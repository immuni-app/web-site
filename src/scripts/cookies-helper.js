export function handleCookies() {
  const addCookieBanner = () => {
    ...
    bannerCookie.innerHTML =
      '<div id="cookie-banner" class="dismissed"><div><span>Questo sito utilizza cookie tecnici, di analytics e di terze parti. Proseguendo la navigazione accetti la nostra Informativa Privacy.<button id="accept-btn">Accetto</button></div>';
